...
pub fn split_sentences(text: &str) -> Vec<&str> {
    ...
    while i < bytes.len() {
        ...
        if c == '\n' || ((c == '.' || c == '!' || c == '?') && bytes.get(i + 1).map_or(true, |b| (*b as char).is_whitespace())) {
...
pub fn is_stopword(w: &str) -> bool {
    ...
    SET.get_or_init(|| STOPWORDS.iter().copied().collect()).contains(w)
}
...
static STOPWORDS: &[&str] = &[
    ...
    "under", "again", "further", "once", "here", "there", "where", "why", "how", "all", "any",
    "both", "each", "few", "more", "most", "other", "some", "such", "no", "nor", "not", "only",
    "own", "same", "so", "than", "too", "very", "can", "will", "just", "should", "now", "i",
    "me", "my", "myself", "we", "our", "ours", "you", "your", "yours", "he", "him", "his",
    "she", "her", "hers", "it", "its", "they", "them", "their", "theirs", "what", "which",
    "who", "whom", "this", "that", "these", "those", "am", "is", "are", "was", "were", "be",
    "been", "being", "have", "has", "had", "having", "do", "does", "did", "doing", "would",
    "could", "ought", "as", "until", "because", "s", "t", "don", "let", "us", "also", "get",
    "got", "like", "yeah", "yes", "okay", "ok", "really", "know", "think", "going", "go",
    "one", "well", "much", "still", "back", "even", "want", "said", "say", "told", "tell",
];
...
mod tests {
    ...
    #[test]
    fn tokenize_basic() {
        assert_eq!(tokenize("Carrie's dog, Lychee!"), vec!["carrie's", "dog", "lychee"]);
    }
